  ...
  return (
    <div className=' text-yellow-sunshine font-josefinSans'>
      {/* <Fade cascade damping={0.3} triggerOnce={true}>   </Fade> */}
        ...
        <ul className='flex justify-between lg:justify-end items-center text-sm md:text-base py-3 px-6  md:mx-24 lg:mx-8 xl:mx-16 lg:gap-8 xl:gap-10 rounded-xl  drop-shadow-2xl '>
